...
--
-- Host: localhost
-- Generation Time: Dec 22, 2023 at 11:32 AM
...
--
ALTER TABLE `ORDER` ADD PRIMARY KEY (`ID`), ADD KEY `FK_INFO_TRANS` (`DETAILID`), ADD KEY `FK_USER_TRANS` (`USERID`);

--
-- Indexes for table `order_detail`
--
ALTER TABLE `ORDER_DETAIL` ADD PRIMARY KEY (`ID`), ADD KEY `FK_GAME_TRANS` (`GAMEID`), ADD KEY `FK_TYPE_TRANS` (`TYPEID`);

--
-- Indexes for table `order_type`
--
ALTER TABLE `ORDER_TYPE` ADD PRIMARY KEY (`ID`);
...
--
ALTER TABLE `ADDRESS` MODIFY `ID` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `CARTS` MODIFY `ID` INT(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `ORDER` MODIFY `ID` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `order_detail`
--
ALTER TABLE `ORDER_DETAIL` MODIFY `ID` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `order_type`
--
ALTER TABLE `ORDER_TYPE` MODIFY `ID` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `ORDER` ADD CONSTRAINT `FK_DETAIL_ORD` FOREIGN KEY (`DETAILID`) REFERENCES `ORDER_DETAIL` (`ID`), ADD CONSTRAINT `FK_USER_ORD` FOREIGN KEY (`USERID`) REFERENCES `ASPNETUSERS` (`ID`);

--
-- Constraints for table `order_detail`
--
ALTER TABLE `ORDER_DETAIL` ADD CONSTRAINT `FK_GAME_TRANS` FOREIGN KEY (`GAMEID`) REFERENCES `GAME` (`ID`), ADD CONSTRAINT `FK_TYPE_TRANS` FOREIGN KEY (`TYPEID`) REFERENCES `ORDER_TYPE` (`ID`);
